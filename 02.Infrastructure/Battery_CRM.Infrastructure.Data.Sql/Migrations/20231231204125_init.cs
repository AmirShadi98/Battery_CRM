        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Message_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Branches",
                columns: new[] { "Id", "Address", "CreateDate", "DeleteDate", "IsDelete", "Name", "PhoneNumber", "UpdateDate" },
                values: new object[] { 1, "تبریز", new DateTime(2023, 12, 31, 20, 41, 24, 822, DateTimeKind.Utc).AddTicks(9578), null, false, "امامیه", 9146400136L, null });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreateDate", "DeleteDate", "Family", "IsDelete", "Name", "Password", "PhoneNumber", "RoleId", "UpdateDate", "UserName" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 11, 24, 823, DateTimeKind.Local).AddTicks(4540), null, "شادی", false, "امیر", "gdyb21LQTcIANtvYMT7QVQ==", 0L, 1, null, "amir" });
